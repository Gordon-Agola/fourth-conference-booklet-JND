...
public class SubTheme5Adapter extends RecyclerView.Adapter<SubTheme5Adapter.ViewHolder> {
    ...
    public SubTheme5Adapter(Context context, ArrayList<SubjectModel> list) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, @SuppressLint("RecyclerView") int position) {
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(context, SubTheme5PdfView.class);
