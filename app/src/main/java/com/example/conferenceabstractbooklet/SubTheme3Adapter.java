...
public class SubTheme3Adapter extends RecyclerView.Adapter<SubTheme3Adapter.ViewHolder> {
    ...
    public SubTheme3Adapter(Context context, ArrayList<SubjectModel> list) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, @SuppressLint("RecyclerView") int position) {
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(context, SubTheme3PdfView.class);
