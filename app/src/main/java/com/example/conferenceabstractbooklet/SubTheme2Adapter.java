...
public class SubTheme2Adapter extends RecyclerView.Adapter<SubTheme2Adapter.ViewHolder> {
    ...
    public SubTheme2Adapter(Context context, ArrayList<SubjectModel> list) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, @SuppressLint("RecyclerView") int position) {
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(context, SubTheme2PdfView.class);
