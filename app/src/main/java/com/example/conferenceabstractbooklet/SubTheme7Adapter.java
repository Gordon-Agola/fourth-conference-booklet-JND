...
public class SubTheme7Adapter extends RecyclerView.Adapter<SubTheme7Adapter.ViewHolder> {
    ...
    public SubTheme7Adapter(Context context, ArrayList<SubjectModel> list) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, @SuppressLint("RecyclerView") int position) {
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(context, SubTheme7PdfView.class);
