...
public class SubTheme6Adapter extends RecyclerView.Adapter<SubTheme6Adapter.ViewHolder> {
    ...
    public SubTheme6Adapter(Context context, ArrayList<SubjectModel> list) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, @SuppressLint("RecyclerView") int position) {
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(context, SubTheme6PdfView.class);
