...
public class AbstractAdapter extends RecyclerView.Adapter<AbstractAdapter.ViewHolder> {
    ...
    public AbstractAdapter(Context context, ArrayList<SubjectModel> list) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, @SuppressLint("RecyclerView") int position) {
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(context, PdfAbstractsActivity.class);
